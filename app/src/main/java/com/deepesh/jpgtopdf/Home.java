...
public class Home extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        morphToSquare1(addImages, integer(R.integer.mb_animation));
    ...
    private void morphToSquare(final MorphingButton btnMorph, int duration) {
        MorphingButton.Params square = MorphingButton.Params.create()
                ...
                .color(color(R.color.colorPrimaryDark))
                .colorPressed(color(R.color.colorPrimary))
    ...
    private void morphToSquare1(final MorphingButton btnMorph, int duration) {
        MorphingButton.Params square = MorphingButton.Params.create()
                ...
                .height(dimen(R.dimen.mb_height_45))
                .color(color(R.color.holo_red_light))
                .colorPressed(color(R.color.colorPrimary))
                .text(getString(R.string.select_images_text));
        btnMorph.morph(square);
    }
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                for (int i = 0; i < imagesUri.size(); i++) {
                    ...
                    image = com.itextpdf.text.Image.getInstance(imagesUri.get(i));
